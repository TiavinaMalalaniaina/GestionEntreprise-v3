        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card tale-bg"  style="background-color: white;">
                        <div class="card-people mt-auto">
                            <div style="padding-bottom: 40px;">
                                <span>BETIAM</span>
                            </div>
                            <img src="/back_office/images/logo1.PNG" alt="people">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 stretch-card transparent">
                            <div class="card card-tale">
                                <div class="card-body">
                                    <p class="mb-4">Informatique</p>
                                    <p class="fs-30 mb-2">20 employes</p>
                                    <p>40.00%</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 stretch-card transparent">
                            <div class="card card-dark-blue">
                                <div class="card-body">
                                    <p class="mb-4">Ressources humaines</p>
                                    <p class="fs-30 mb-2">10 employes</p>
                                    <p>20.00%</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                            <div class="card card-light-blue">
                                <div class="card-body">
                                    ...
                                    <p class="fs-30 mb-2">15 employes</p>
                                    <p>30.00%</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 stretch-card transparent">
                            <div class="card card-light-danger">
                                <div class="card-body">
                                    <p class="mb-4">Securité</p>
                                    <p class="fs-30 mb-2">5 employes</p>
                                    <p>10.00%</p>
                                </div>
                            </div>
                        </div>
