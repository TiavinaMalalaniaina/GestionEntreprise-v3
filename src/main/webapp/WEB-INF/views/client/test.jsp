                    ...
                    <form>
                        ...
                        <div class="mb-4 form-check">
                            <div class="field tinted">
                                <% int i = 1; %>
                                <% for(Question questionnaires : questionnaire.getQuestions()) { %>
                                <h6 class="titre"><%= i++ %>)  <%= questionnaires.getValeur() %></h6>
                                    <% for(Reponse reponse : questionnaires.getReponses()) { %>
                                    <% if(questionnaires.getType().equals("text")) { %>
                                        <textarea name="demo-message" id="demo-message" rows="2" class="form-control"></textarea>
                                <% }else { %>
                                        <input type="<%= questionnaires.getType() %>" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1"><%= reponse.getValeur() %></label>
                                </br>
                                <% } %>
                                    <% } %>
                            </br>
