...
<nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
    <div class="container">
        ...
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
            ...
            <span class="nav-item">
                        <a class="btn-outline-sm" href="log">Log in</a>
                    </span>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <a class="btn-solid-lg" href="sign">Sign up for free</a>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
            <div class="col-lg-6">
                <div class="image-container">
                    <img class="img-fluid" src="/assets_client/images/header-illustration.svg" alt="alternative">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-xl-7">
                <div class="image-container">
                    <img class="img-fluid" src="/assets_client/images/details-1.svg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="/assets_client/images/details-modal.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-4">
                    <h3>Goals Setting</h3>
...
<div class="basic-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="image-container">
                    <img class="img-fluid" src="/assets_client/images/details-2.png" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <div class="swiper-container card-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="/assets_client/images/testimonial-1.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="/assets_client/images/testimonial-2.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="/assets_client/images/testimonial-3.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="/assets_client/images/testimonial-4.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="/assets_client/images/testimonial-5.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="/assets_client/images/testimonial-6.jpg" alt="alternative">
                                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <a class="btn-outline-lg page-scroll" href="sign">Sign up for free</a>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
</div> <!-- end of basic-3 -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <img class="decoration-lines" src="/assets_client/images/decoration-lines.svg" alt="alternative"><span>Free tier</span><img class="decoration-lines flipped" src="/assets_client/images/decoration-lines.svg" alt="alternative">
                        </div>
                        <ul class="list-unstyled li-space-lg">
                        ...
                        <a href="sign" class="btn-solid-reg">Sign up</a>
                    </div>
                </div>
                <!-- end of card -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <img class="decoration-lines" src="/assets_client/images/decoration-lines.svg" alt="alternative"><span>Advanced</span><img class="decoration-lines flipped" src="/assets_client/images/decoration-lines.svg" alt="alternative">
                        </div>
                        <ul class="list-unstyled li-space-lg">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <img class="decoration-lines" src="/assets_client/+images/decoration-lines.svg" alt="alternative"><span>Professional</span><img class="decoration-lines flipped" src="/assets_client/images/decoration-lines.svg" alt="alternative">
                        </div>
                        <ul class="list-unstyled li-space-lg">
